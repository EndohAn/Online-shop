...
const Promo = () => {
    ...
    useLayoutEffect( () => {
        let ctx = gsap.context( () => {
            ...
            gsap.to(".present", {delay: 0.5,rotation: 360, y:400, duration: 2, opacity: 1, scale: 2, ease: "bounce"})
        }, app);
        
        const onMove = () => {
        gsap.to(".present", {delay: 6, duration: 1, opacity: 0, display: "none"})
        gsap.to(".present-text", {delay: 4, duration: 0.3, text: 'Удачных покупок!', ease: "power2"})
        };
    ...
    return (
        ...
        <div ref={app} className='present-box box-present'>
            ...
            <h3 className='present-text'>Нажми на картинку и получи подарок !</h3>
        </div>
